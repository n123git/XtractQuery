...
| 523 | Remaps the value of a variable to another literal value or variable or sets a default.<br><pre>$local1 = $local2 switch <br>{<br>    1 => 99<br>    2 => $object1<br>    3 => $local3<br>    _ => 0<br>};</pre> |
