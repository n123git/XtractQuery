...
| ```$local0``` | A value, that persists only in the function it was set in. Used for temporaries (variables that didnt exidt in Level5's source but were generated by the compiler). |
